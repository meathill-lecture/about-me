...
我希望大家通过学习本节课，可以对前端有比较充分的理解，能够知道为什么前端变化这么快、这么大；为什么各种工具、框架、技术层出不穷；这样的变化会是否会持续下去；如何选择自学的方向。
